...
async function bootstrap() {
  ...
  SwaggerModule.setup('swagger', app, document); //включаем документацию Swagger по пути localhost:3001/api_docs
  await app.listen(7363); //устанавливаем порт прослушивания 3001
